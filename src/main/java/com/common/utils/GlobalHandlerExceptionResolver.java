...
import com.common.validator.Aop.TestValidateParam.ParamValidException;
...
public class GlobalHandlerExceptionResolver implements HandlerExceptionResolver {
    ...
    public ModelAndView resolveException(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o, Exception e) {
      ...
      /*  HandlerMethod method = (HandlerMethod)o;https://my.oschina.net/FengJ/blog/223727*/
        ...
        if(e instanceof ConstraintViolationException){
           ...
           // modelAndView.addObject("listerror",constraintViolations);
           ...
           for(FieldError fieldError:fieldErrorList){
            ...
            modelAndView.addObject("listerror",fieldErrorList);
        }
